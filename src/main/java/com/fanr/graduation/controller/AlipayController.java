...
import com.fanr.graduation.service.AlipayService;
...
public class AlipayController {
    ...
    public Map<Object, Object> getPagePay() throws Exception{
        /** 模仿数据库，从后台调数据*/
        String outTradeNo = "alipay" + createOrder();
...
//        System.out.println(pay);
    ...
    public Result getAppPagePay() throws Exception{
        /** 模仿数据库，从后台调数据*/
    ...
    public Result alipayQuery() throws Exception{
        /**调取支付订单号*/
    ...
    public Result refundQuery() throws AlipayApiException{
    ...
    public Result alipaycolse() throws AlipayApiException{
        ...
        return ResultUtil.success(close);
    }
    ...
    private static String createOrder(){
        long order = System.currentTimeMillis();   //获取开始时间
        String no = String.valueOf(order);
//        System.out.println("no = " + no);
//        String str = no.substring(0,6);
//        System.out.println("no.substring(0,6) = " + str);
//        System.out.println("no.replace('1','a') = " + no.replace(str,"alipay"));
//        no.replace(no.substring(6),"aplipay");
        return no;
    }
