...
//        g.setColor(Color.WHITE);	//把环境(画笔)设置成白色
//        g.fillRect(0, 0, 70, 35); //填充矩形 从0,0点开始,宽70,高35,即为图片为背景色
//        g.setColor(Color.RED);
//        g.drawString("Hello", 2, 35-2); //向图片写入字符串 其中2,2表示xy轴的坐标
//        try {
...
//        }
        ...
        try {
            VerifyCode.output(bi, new FileOutputStream("F:/yyy.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
